...
int main(void)
{
	...
	Complex c2(3, 0);
	Complex c3(c2);
	Complex c4(-4.5, -3.1235); // c4 = c2 + c3?

	cout << "c1 = " << c1.to_string() << endl; // Prints complex number c1 by "real number" + "complex number"
	cout << "c2 = " << c2.to_string() << endl;
	cout << "c3 = " << c3.to_string() << endl;
	cout << "c4 = " << c4.to_string() << endl;

	c4 = c2.add(c3); // Method used: add( complex c )
	cout << "c4 = c2+c3 = " << c4.to_string() << endl;
	c4 = c2.add(4.5); // Method used: add ( float a )
	cout << "c4 = c2+4.5 = " << c4.to_string() << endl;
	c4 = c2.add(4); // Method used: add ( float a )
	cout << "c4 = c2+4 = " << c4.to_string() << endl;

	Complex c7(3, -4);
	float f = c7.abs(); // Method used: abs()
